...
TRANSLATIONS = {
    "en": {
        ...
        "checkbox_auto_update": "Check for Updates on Startup",
        "tooltip_notifications": "Show desktop notifications for download events",
        "tooltip_auto_update": "Automatically check for new versions when app starts",
        ...
        "group_playlist_subtitles": "Subtitles",
    ...
    "he": {
        ...
        "checkbox_auto_update": "בדוק עדכונים בהפעלה",
        "tooltip_notifications": "הצג התראות שולחן עבודה לאירועי הורדה",
        "tooltip_auto_update": "בדוק אוטומטית גרסאות חדשות כאשר האפליקציה מופעלת",
        ...
        # Playlist Dialog - Subtitles section
        "group_playlist_subtitles": "כתוביות",
