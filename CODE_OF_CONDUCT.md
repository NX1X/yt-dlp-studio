...
We as members, contributors, and maintainers of YT-DLP Studio pledge to make
...
comments, commits, code, issues, pull requests, and other contributions that
...
requests, discussions, code reviews) and also applies when an individual is
officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers via [nx1xlab.dev](https://nx1xlab.dev).
